...
class Agent:
    ...
    def move(self, model):
        ...
        for speed in self.speeds:
            ...
            if not Agent.collision(model, new_location):
                ...
                # Wiggle
                new_location = self.location + self.wiggle*np.random.randint(-1,
                                                                             2, 2)
        # Rebound
    ...
    def neighbourhood(cls, model, new_location):
        ...
        Answer: This method finds whether or not nearby neighbours are a collision.
    ...
    def lerp(cls, loc1, loc2, speed):
        ...
        lerp is a intensively used method
        profiling and adjustments have been made
